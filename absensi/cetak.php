...
<html lang="en">
  ...
  <body>
    <div class="container">
<?php
   echo '<h3>Bukti Absensi Siswa</h3>';
   ...
   echo '<tr><td colspan="2">Nomor Induk Siswa</td><td colspan="3">'.$nis.'</td></tr>';
   echo '<tr><td colspan="2">Nama Siswa</td><td colspan="3">'.$idprodi.'</td></tr>';
