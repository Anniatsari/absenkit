  ...
  <div class="container">
	...
	<div class="navbar-collapse collapse">
	  <ul class="nav navbar-nav">
		...
		<li><a href="./admin.php?hlm=bayar">Absen</a></li>
		<li class="dropdown">
		  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Laporan <b class="caret"></b></a>
		  <ul class="dropdown-menu">
			<li><a href="./admin.php?hlm=laporan">Rekap Absensi</a></li>
			<li><a href="./admin.php?hlm=laporan&sub=tagihan">Print Absensi</a></li>
		  </ul>
		</li>
		<li class="dropdown">
		  ...
		  <ul class="dropdown-menu">
			...
			?>
			<li class="divider"></li>
			<li><a href="./admin.php?hlm=master&sub=jenis">Jenis</a></li>
