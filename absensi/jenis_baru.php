...
<form method="post" action="admin.php?hlm=master&sub=jenis&aksi=baru" class="form-horizontal" role="form">
	...
	<div class="form-group">
		<label for="jumlah" class="col-sm-2 control-label">Jumlah Siswa</label>
		<div class="col-sm-3">
			<div class="input-group">
			
			<input type="text" class="form-control" id="jumlah" name="jumlah" placeholder="Jumlah Siswa" required>
			</div>
		</div>
	</div>
	<div class="form-group">
